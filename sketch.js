...
if(count>=5){
  ...
  if(count>=5){
  ...
  else if(particle.body.position.x<540){
    score=score+500
    particle=null
    if(count>=5){
      gameState="end"
  ...
  else if(particle.body.position.x<620){
    score=score+100
    particle=null
    if (count>=5){
      gameState="end"
    ...
    else if (particle.body.position.x<860){
      score=score+200
      particle=null
      if(count>=5){
        gameState="end"
    ...
    else if (particle.body.position.x<940){
      score=score+200
      particle=null
      if(count>=5){
        gameState="end"
    ...
    else if (particle.body.position.x<1020){
      score=score+200
      particle=null
      if(count>=5){
        gameState="end"
